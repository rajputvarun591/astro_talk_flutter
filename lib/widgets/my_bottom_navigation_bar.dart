import 'package:astro_talk_flutter/widgets/bottom_bar_tile.dart';
...
class MyBottomNavigationBar extends StatefulWidget {
  ...
  const MyBottomNavigationBar({Key? key, required this.onTap, required this.backgroundColor, required this.currentIndex}) : super(key: key);
