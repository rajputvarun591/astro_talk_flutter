        ...
        Container(
          ...
          child: Row(
            children: [
              Text(
                "Wallet Balance: ₹0",
                style: kTextStyle.copyWith(color: Colors.white, fontSize: 16.00, fontWeight: FontWeight.w700),
              ),
              const Spacer(),
              ElevatedButton(
                onPressed: () {},
            ...
            body: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    "Ask a Question",
                    style: kTextStyle.copyWith(fontSize: 18.00, fontWeight: FontWeight.w700),
                  ),
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 10.0).copyWith(bottom: 15.00),
                    child: Text(
                  ...
                  Consumer<HomeProvider>(
                    builder: (context, provider, child) {
                      if (!provider.isCategoriesLoading) {
                        return Padding(
                          padding: const EdgeInsets.symmetric(vertical: 10.0).copyWith(bottom: 20.00),
                          child: Material(
                              ...
                              child: DropdownButton(
                                items: List.generate(provider.categories.length, (index) {
                                  return DropdownMenuItem(
                                    ...
                                    value: provider.categories[index].id!.toInt(),
                                  );
                                }),
                  ...
                  Container(
                    ...
                    padding: const EdgeInsets.all(10.00),
                    child: RichText(
                        text: TextSpan(style: kTextStyle.copyWith(color: Colors.orange, fontSize: 15.00), children: const [
                      TextSpan(text: "\u2022 Personalized responses provided by our team of Vedic astrologers within 24 hours.\n"),
                      TextSpan(
                          text:
                              "\u2022 Qualified and experienced astrologers will look into your birth chart and provide the right guidance.\n"),
                      TextSpan(text: "\u2022 You can seek answers to any part of your life and for most pressing issue.\n"),
                      TextSpan(
                          text:
